...
from config import first_names, last_names, prefixes, nigerian_states, nigerian_banks, agro_states, farm_types
...
def generate_farmer_df(num_farmers: int) -> pd.DataFrame:
    """
...
def generate_farm_df(num_farmers: int, farmer_ids: list[str]) -> pd.DataFrame:
    """
...
def generate_financial_history_df(num_farmers: int, farmer_ids: list[str]) -> pd.DataFrame:
    """
